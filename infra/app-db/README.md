...
PostgreSQL configuration for a per-app database pod. Every openvoid app gets its own instance of this
— see `docs/plans/2026-08-29-001-feat-app-data-plane-documentdb-plan.md` (U3), and
`docs/spikes/2026-08-29-documentdb-multitenancy.md` for why isolation has to work this way.
...
Each setting was established by a failure in `infra/images/documentdb-gateway/integration-test.sh`, and
...
Both live in `infra/images/documentdb-gateway/README.md`.
