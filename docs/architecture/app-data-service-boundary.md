...
**Working name:** `drigodb` (placeholder). This document does not decide whether to extract the service;
it establishes what the contract would be, so that decision can be made against something concrete.
